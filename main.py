...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/ASHISH_CONTACT_BOT"),
...
async def help_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        ...
        "<pre><code>Contact to 𝐓𝐇𝐀𝐊𝐔𝐑 𝐒𝐀𝐇𝐀𝐁❤️ for buy membership.</code></pre>"
    ))

@bot.on_message(filters.command(["help"]))
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        "<pre><code> 🎉Congrats! You are using 𝐓𝐇𝐀𝐊𝐔𝐑 𝐒𝐀𝐇𝐀𝐁❤️:</code></pre>\n┣\n"
...
async def txt_handler(bot: Client, m: Message):
    ...
    credit = "️[𝐓𝐇𝐀𝐊𝐔𝐑 𝐒𝐀𝐇𝐀𝐁❤️ 🕊️](https://t.me/ASHISH_CONTACT_BOT)"
    if raw_text3 == '1':
        CR = '[𝐓𝐇𝐀𝐊𝐔𝐑 𝐒𝐀𝐇𝐀𝐁❤️ 🕊️](https://t.me/ASHISH_CONTACT_BOT)'
    elif raw_text3:
        try:
            ...
            try:  
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐑𝐎𝐆𝐑𝐄𝐒𝐒 » {progress:.2f}%\n┃\n" \
                           ...
                           f"➽ 𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ `@ASHISH_CONTACT_BOT🐦`"
    ...
    await m.reply_text(f"`✨𝙱𝚊𝚝𝚌𝚑 𝚂𝚞𝚖𝚖𝚊𝚛𝚢✨\n"
                       ...
                       f"▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n"
                       f"✅𝚂𝚝𝚊𝚝𝚞𝚜 » 𝙲𝚘𝚖𝚙𝚕𝚎𝚝𝚎𝚍`")
    await m.reply_text("<pre><code>Downloaded By ⌈✨『𝐓𝐇𝐀𝐊𝐔𝐑 𝐒𝐀𝐇𝐀𝐁❤️』✨⌋</code></pre>")
    ...
    try:
        ...
        # Check if the response status is OK
            ...
            # Remove the PDF file after sending
                    ...
                    emoji_message = await show_random_emojis(message)
                    Show = f"**⚡Dᴏᴡɴʟᴏᴀᴅ Sᴛᴀʀᴛᴇᴅ...⏳**\n\n🔗𝐋𝐢𝐧𝐤 » `{link}`\n\n✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ `@ASHISH_CONTACT_BOT🐦`"
